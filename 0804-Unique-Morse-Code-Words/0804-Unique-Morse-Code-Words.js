...
getIndex = char => char.charCodeAt() - 'a'.charCodeAt();
...
var uniqueMorseRepresentations = function (words) {
  return words.map(word => [...word].map(char => codes[getIndex(char)]).join(''))
...
// Runtime: 64 ms, faster than 34.30% of JavaScript online submissions for Unique Morse Code Words.